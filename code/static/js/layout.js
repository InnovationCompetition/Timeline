(function(){
  angular.module('Layout', ['ngMaterial', 'ui.router', 'myself', 'others', 'pictures', 'timeline', 'relationship', 'punchedCard', 'photo', 'newPost']).config(function($mdThemingProvider, $stateProvider, $urlRouterProvider){
